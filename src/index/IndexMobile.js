        ...
        <>
            ...
            <Box
                ...
                <Box display="flex" height={50}
                    ...
                    <Typography  variant="h3" component="h3"  style={{textAlign: "center", color: "black", paddingTop: 124, paddingBottom: 42, fontWeight: 700, fontSize: "8vw", lineHeight: "1.2em", fontFamily: "Cormorant, sans-serif"}}>
                        We're Gleam a small and enthusiastic photography studio based in  <br/>  New York
                    </Typography>
                </Box>
                <Box display="flex" height={80}
                     alignItems="center"
                     justifyContent="center"
                     style={{marginTop: 124, lineHeight: 1.7, textAlign: "center"}}>
                    <Typography variant="body1" component="body1" style={{marginTop:24, fontSize: "4vw", fontWeight: 400}}>
                    ...
                    <Parallax bgImage={image3} strength={300}>
                        <div style={{ height: 300,
                            ...
                            <div style={insideStyles}>
                                <Typography variant="h2" style={{fontSize: "5vw", textAlign: "center", color: "white", fontStyle: "italic", fontWeight: "bold"}} component="h2" >
                ...
                <Box display="flex" height={240}
                    ...
                    <Grid
                        ...
                        <Grid xs={12} item>
                            <Container>
                                <Typography variant="h2"  component="h2" style={{fontSize: "5.5vw", lineClamp: 2, color: "black",fontWeight: 700}}>

                                   If you want to work <br/> with us  send a message.
